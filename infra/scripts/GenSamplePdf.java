...
public class GenSamplePdf {
    public static void main(String[] args) throws Exception {
        File out = args.length > 0 ? new File(args[0]) : new File("samples/loan-app.pdf");
        ...
        System.out.println("Created sample PDF: " + out.getAbsolutePath());
    }
}
